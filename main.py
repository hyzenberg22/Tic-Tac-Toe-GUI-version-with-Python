...
root = Tk()
root.title("Tic-Tac-Toe made by Shubhajit")
...
def checkifwon():
    global winner
    #This is if the x win in the Row
    if b1["text"] == "X" and b2["text"] == "X" and b3["text"] == "X":
        ...
        messagebox.showinfo("Tic-Tac-Toe", "Congratulations X Wins..!")
        disable_all_buttons()
    # This is for the column if the x wins 
        ...
        messagebox.showinfo("Tic-Tac-Toe", "Congratulations X Wins..!")
        disable_all_buttons()
    # This is for the diagonal if the x wins 
        ...
        messagebox.showinfo("Tic-Tac-Toe", "Congratulations X Wins..!")
        disable_all_buttons()
    # This is the condition if the O wins
        ...
        messagebox.showinfo("Tic-Tac-Toe", "Congratulations O Wins..!")
        disable_all_buttons()
    # This is for the column if the O wins 
        ...
        messagebox.showinfo("Tic-Tac-Toe", "Congratulations O Wins..!")
        disable_all_buttons()
    # This is for the diagonal if the O wins 
...
# Built the Buttons
    ...
    # Grid the Button sto the screen
